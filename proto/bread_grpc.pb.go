...
type BakeryBreadServiceClient interface {
	...
	BreadUpdates(ctx context.Context, in *BakeryRequestList, opts ...grpc.CallOption) (BakeryBreadService_BreadUpdatesClient, error)
...
func (c *bakeryBreadServiceClient) BreadUpdates(ctx context.Context, in *BakeryRequestList, opts ...grpc.CallOption) (BakeryBreadService_BreadUpdatesClient, error) {
	stream, err := c.cc.NewStream(ctx, &BakeryBreadService_ServiceDesc.Streams[0], "/bread.BakeryBreadService/BreadUpdates", opts...)
	if err != nil {
		return nil, err
	}
	x := &bakeryBreadServiceBreadUpdatesClient{stream}
...
type BakeryBreadService_BreadUpdatesClient interface {
	Recv() (*BakeryResponseList, error)
	grpc.ClientStream
}

type bakeryBreadServiceBreadUpdatesClient struct {
	grpc.ClientStream
}

func (x *bakeryBreadServiceBreadUpdatesClient) Recv() (*BakeryResponseList, error) {
	m := new(BakeryResponseList)
...
type BakeryBreadServiceServer interface {
	...
	BreadUpdates(*BakeryRequestList, BakeryBreadService_BreadUpdatesServer) error
...
func (UnimplementedBakeryBreadServiceServer) BreadUpdates(*BakeryRequestList, BakeryBreadService_BreadUpdatesServer) error {
	return status.Errorf(codes.Unimplemented, "method BreadUpdates not implemented")
}
...
func _BakeryBreadService_BreadUpdates_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(BakeryRequestList)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(BakeryBreadServiceServer).BreadUpdates(m, &bakeryBreadServiceBreadUpdatesServer{stream})
}

type BakeryBreadService_BreadUpdatesServer interface {
	Send(*BakeryResponseList) error
	grpc.ServerStream
}

type bakeryBreadServiceBreadUpdatesServer struct {
	grpc.ServerStream
}

func (x *bakeryBreadServiceBreadUpdatesServer) Send(m *BakeryResponseList) error {
...
var BakeryBreadService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "BreadUpdates",
			Handler:       _BakeryBreadService_BreadUpdates_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "proto/bread.proto",
