...
const (
	BrokerService_ReportOrder_FullMethodName           = "/bread.BrokerService/ReportOrder"
	BrokerService_ReserveInventory_FullMethodName      = "/bread.BrokerService/ReserveInventory"
	BrokerService_ReportMatchingResults_FullMethodName = "/bread.BrokerService/ReportMatchingResults"
)
...
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
//
// BrokerService is the server-side interface the broker uses for ALL
// data operations. The broker connects to the server's gRPC port and
// calls these methods instead of accessing PostgreSQL directly.
//
// Flow:
//  1. Broker consumes order from RabbitMQ → calls ReportOrder
//     Server: checks UUID dedup → inserts into DB → returns order ID
//  2. Broker buffers orders for batch matching
//  3. For each item in batch: calls ReserveInventory
//     Server: atomic SELECT FOR UPDATE + deduct stock → returns result
//  4. After batch complete: calls ReportMatchingResults
//     Server: updates order status + writes to outbox (DB tx)
//  5. Server's outbox publisher → publishes to bread-bought queue
//  6. Server's settlement dispatcher → streams to buyers
type BrokerServiceClient interface {
	...
	ReportOrder(ctx context.Context, in *BuyOrder, opts ...grpc.CallOption) (*BrokerOrderResult, error)
	// ReserveInventory atomically checks and deducts stock for one
	// item in a matching batch. This is the broker's replacement for
	// direct FulfillOrderItem DB calls.
	ReserveInventory(ctx context.Context, in *ReserveInventoryRequest, opts ...grpc.CallOption) (*ReserveInventoryResult, error)
	...
	ReportMatchingResults(ctx context.Context, in *MatchingBatch, opts ...grpc.CallOption) (*BatchConfirmation, error)
}
...
func (c *brokerServiceClient) ReportOrder(ctx context.Context, in *BuyOrder, opts ...grpc.CallOption) (*BrokerOrderResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BrokerOrderResult)
	err := c.cc.Invoke(ctx, BrokerService_ReportOrder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *brokerServiceClient) ReserveInventory(ctx context.Context, in *ReserveInventoryRequest, opts ...grpc.CallOption) (*ReserveInventoryResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReserveInventoryResult)
	err := c.cc.Invoke(ctx, BrokerService_ReserveInventory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *brokerServiceClient) ReportMatchingResults(ctx context.Context, in *MatchingBatch, opts ...grpc.CallOption) (*BatchConfirmation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchConfirmation)
	err := c.cc.Invoke(ctx, BrokerService_ReportMatchingResults_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BrokerServiceServer interface {
	// ReportOrder notifies the server of a new order consumed from
	// RabbitMQ. The server handles deduplication and persistence.
	ReportOrder(context.Context, *BuyOrder) (*BrokerOrderResult, error)
	// ReserveInventory atomically checks and deducts stock for one
	// item in a matching batch. This is the broker's replacement for
	// direct FulfillOrderItem DB calls.
	ReserveInventory(context.Context, *ReserveInventoryRequest) (*ReserveInventoryResult, error)
	// ReportMatchingResults sends the complete batch matching results
	// to the server. The server updates order statuses and writes
	// results to the outbox in a single transaction.
	ReportMatchingResults(context.Context, *MatchingBatch) (*BatchConfirmation, error)
...
func (UnimplementedBrokerServiceServer) ReportOrder(context.Context, *BuyOrder) (*BrokerOrderResult, error) {
	return nil, status.Error(codes.Unimplemented, "method ReportOrder not implemented")
}
func (UnimplementedBrokerServiceServer) ReserveInventory(context.Context, *ReserveInventoryRequest) (*ReserveInventoryResult, error) {
	return nil, status.Error(codes.Unimplemented, "method ReserveInventory not implemented")
}
func (UnimplementedBrokerServiceServer) ReportMatchingResults(context.Context, *MatchingBatch) (*BatchConfirmation, error) {
	return nil, status.Error(codes.Unimplemented, "method ReportMatchingResults not implemented")
}
...
func _BrokerService_ReportOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BuyOrder)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BrokerServiceServer).ReportOrder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BrokerService_ReportOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BrokerServiceServer).ReportOrder(ctx, req.(*BuyOrder))
	}
	return interceptor(ctx, in, info, handler)
}

func _BrokerService_ReserveInventory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReserveInventoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BrokerServiceServer).ReserveInventory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BrokerService_ReserveInventory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BrokerServiceServer).ReserveInventory(ctx, req.(*ReserveInventoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _BrokerService_ReportMatchingResults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MatchingBatch)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BrokerServiceServer).ReportMatchingResults(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BrokerService_ReportMatchingResults_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BrokerServiceServer).ReportMatchingResults(ctx, req.(*MatchingBatch))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BrokerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bread.BrokerService",
	HandlerType: (*BrokerServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ReportOrder",
			Handler:    _BrokerService_ReportOrder_Handler,
		},
		{
			MethodName: "ReserveInventory",
			Handler:    _BrokerService_ReserveInventory_Handler,
		},
		{
			MethodName: "ReportMatchingResults",
			Handler:    _BrokerService_ReportMatchingResults_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "bread.proto",
